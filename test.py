...
parser.add_argument('-n', '--neighbors', action="store", type=int, dest='neighbors', default=5, help="Cascade classifier parameter- higher is more sensitive, see openCV docs for more details")
